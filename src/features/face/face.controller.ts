import {Body, Controller, Get, HttpCode, HttpStatus, ParseFilePipeBuilder, Post, UploadedFile, UseInterceptors} from "@nestjs/common";
...
export class FaceController {
    ...
    @HttpCode(HttpStatus.OK)
    @Post("queryFace")
    async queryFaceMatchs(@Body() payload:QueryFaceDto){
